    ...
    <div class="col-md-12">
        <div class="row no-gutters p-3 border rounded d-flex align-items-center flex-md-row mb-4 shadow-sm position-relative">
            <div class="col p-3 d-flex flex-column position-static">
                ...
                @else
                    <div class="alert alert-warning">Produit {{$stock}}, vous ne pouvez pas l'ajouter au panier</div>
                @endif
            </div>
            <div class="col-auto d-none d-lg-block">
                <img src="{{ asset('storage/' . $product->image) }}" id="mainImage" class="img-fluid">
                <div class="mt-2">
                    @if ($product->images)
